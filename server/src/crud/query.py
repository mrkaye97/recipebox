...
SELECT recipe_id, dietary_restriction
...
SELECT recipe_id, name, quantity, units, created_at, updated_at
...
SELECT recipe_id, step_number, content, created_at, updated_at
